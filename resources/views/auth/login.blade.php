...
<body class="app flex-row align-items-center"
    style="background-image: url({{ asset('assets/images/bg-login.jpeg') }}); backround-repeat: no-repeat; background-size: cover;">
    <div class="container">
                ...
                <div class="card-group">
                    ...
                    <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                        <div class="card-body text-center">
                            <div>
                                <h2>Sign up</h2>
                                <p>JIka belum punya akun seilahkan mendaftar disini</p>
