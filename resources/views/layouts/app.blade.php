...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown show">
                <a id="dropdownMenu" class="nav-link" style="margin-right: 10px" data-toggle="dropdown" href="#"
    ...
    <script src="{{ asset('assets/vendor/libs/bootstrap-datepicker/datepicker.js') }}"></script>
    @yield('page-script')
    @stack('scripts')
</body>
