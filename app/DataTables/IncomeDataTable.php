...
class IncomeDataTable extends DataTable
{
    ...
    {
        return [
            ['data' => 'income_date', 'name' => 'income_date', 'title' => 'Tanggal'],
            ['data' => 'nominal', 'name' => 'nominal', 'title' => 'Nominal (Rp)'],
            // ['data' => 'service_category_id', 'name' => 'service_category_id', 'title' => 'Kategori'],
        ];
    }
